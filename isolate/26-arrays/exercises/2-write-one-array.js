...
//Hello me. It is time for nesting arrays. Forget it, its just a repeated string:
//This one is just equating the variable to the array. NO not in this case dear 'me':
...
const temp = plants[2];//temp takes the value 'carrot'
plants[2] = plants[0];//'carrot' takes value 'bush', so there is two 'bush' values, until...
plants[0] = temp;//'bush' takes the first 'carrot' value
...
const mixed = [null,false,true,'tall'];
// leave this code as it is!
mixed[1] = false; //so 'false' become 'null'. we have 2 nulls
mixed[0] = mixed[1];//and the first 'null' become
mixed[1] = null;//and then index 1 is 'null' againg instead of 'false'
