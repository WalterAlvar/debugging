...
// leave this code!
const temp = otherArray2[1];//temp become -false-
otherArray2[1] = otherArray2[2];//-false- become -''- , so we have 2 -''-
otherArray2[2] = temp;//the second -''- become -false-
//thus: otherArray2 = [true,'',false] 
...
// leave this code!
otherArray3[1] = array3[2];//-hi- becomes -middle-
otherArray3[3] = array3[0];//-undefined- becomes -hi-
otherArray3[2] = array3[3];//-undefined- becomes -end-
//thus: otherArray3 = ['bye','middle','end','hi']
